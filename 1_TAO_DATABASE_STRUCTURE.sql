-- ============================================================
--  FILE 1: TẠO CẤU TRÚC DATABASE (SCHEMA)
--  File này tạo tất cả các bảng trong database
...
CREATE TABLE IF NOT EXISTS apartment_service_fee (
    ...
    status VARCHAR(30) DEFAULT 'CHỜ_THANH_TOÁN' COMMENT 'CHỜ_THANH_TOÁN, ĐÃ_THANH_TOÁN, QUÁ_HẠN, ĐÃ_HỦY',
...
CREATE TABLE IF NOT EXISTS invoice (
    ...
    payment_method VARCHAR(50) COMMENT 'TIỀN_MẶT, CHUYỂN_KHOẢN, VNPAY, MOMO, QR_CODE, KHÁC',
...
CREATE TABLE IF NOT EXISTS payment_history (
    ...
    payment_method VARCHAR(50) NOT NULL COMMENT 'TIỀN_MẶT, CHUYỂN_KHOẢN, VNPAY, MOMO',
    payment_reference VARCHAR(100) COMMENT 'Mã tham chiếu',
...
CREATE TABLE IF NOT EXISTS notification (
    id INT AUTO_INCREMENT PRIMARY KEY,
    notification_type VARCHAR(50) NOT NULL COMMENT 'THÔNG_BÁO_CHUNG, THÔNG_BÁO_HÓA_ĐƠN, YÊU_CẦU, NHẮC_NỢ, BẢO_TRÌ, AN_NINH, SỰ_KIỆN',
