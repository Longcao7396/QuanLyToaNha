-- ============================================================
--  FILE SQL - DỮ LIỆU MẪU CHO CÁC MODULE
--  File này chứa dữ liệu mẫu để test các module
--  CHẠY SAU KHI đã chạy file 00_TONG_HOP_TAT_CA.sql
-- ============================================================

USE quanlytoanha;

-- ======================
-- 1. INSERT APARTMENT (Căn hộ mẫu)
-- ======================
...
-- ======================
-- 4. INSERT APARTMENT_SERVICE_FEE (Phí dịch vụ mẫu)
-- ======================
...
((SELECT id FROM apartment WHERE apartment_no = '1208'), (SELECT id FROM service_fee_type WHERE fee_code = 'QL'), 12, 2024, NULL, NULL, 85.5, 15000, 1282500, '2024-12-25', 'CHƯA_THANH_TOÁN'),
((SELECT id FROM apartment WHERE apartment_no = '1208'), (SELECT id FROM service_fee_type WHERE fee_code = 'DIEN'), 12, 2024, 1234, 1345, 111, 3000, 333000, '2024-12-25', 'CHƯA_THANH_TOÁN'),
((SELECT id FROM apartment WHERE apartment_no = '1208'), (SELECT id FROM service_fee_type WHERE fee_code = 'NUOC'), 12, 2024, 56, 63, 7, 20000, 140000, '2024-12-25', 'CHƯA_THANH_TOÁN'),
...
((SELECT id FROM apartment WHERE apartment_no = '0815'), (SELECT id FROM service_fee_type WHERE fee_code = 'QL'), 12, 2024, NULL, NULL, 120.0, 15000, 1800000, '2024-12-25', 'CHƯA_THANH_TOÁN'),
((SELECT id FROM apartment WHERE apartment_no = '0512'), (SELECT id FROM service_fee_type WHERE fee_code = 'VE_SINH'), 12, 2024, NULL, NULL, 1, 100000, 100000, '2024-12-25', 'CHƯA_THANH_TOÁN'),
...
('HD-2024-12-1005-001', (SELECT id FROM apartment WHERE apartment_no = '1005'), (SELECT id FROM resident WHERE identity_card = '234567890123'), 12, 2024, '2024-12-01', '2024-12-25', 1182000, 1182000, 0, 'ĐÃ_THANH_TOÁN', 'BANK_TRANSFER'),
...
('HD-2024-11-1208-001', (SELECT id FROM apartment WHERE apartment_no = '1208'), (SELECT id FROM resident WHERE identity_card = '123456789012'), 11, 2024, '2024-11-01', '2024-11-25', 1650000, 1650000, 0, 'ĐÃ_THANH_TOÁN', 'CASH'),
...
-- ======================
-- 6. INSERT NOTIFICATION (Thông báo mẫu)
-- ======================
...
-- ======================
-- 7. INSERT TICKET (Yêu cầu & Sự cố mẫu)
-- ======================
...
SELECT '✅ Đã insert dữ liệu mẫu cho các module thành công!' as Status;
