...
echo [INFO] Dang gui thong bao DRAFT...
echo.

REM Chạy gửi thông báo (không import)
java -cp "!CLASSPATH!" com.example.quanlytoanhanhom4.util.NotificationImporter --send-only

if errorlevel 1 (
    echo.
    echo [ERROR] Gui thong bao that bai!
    ...
    echo.
    echo [SUCCESS] Gui thong bao hoan tat!
    pause
)
